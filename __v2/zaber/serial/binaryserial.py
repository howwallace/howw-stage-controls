...
class BinarySerial(object):
    ...
    def read_device(self, device_number):
        ...
        #print("(S): 1st reply: %s" %parsed_reply)

        while (parsed_reply.command_number is 40) or (parsed_reply.device_number is not device_number):
               
            if parsed_reply.device_number is not device_number:
            ...
            #print("(S): another reply: %s" %parsed_reply)
