...
PROGRAM:	keithley_handler.py
AUTHOR:		T. Max Roberts
DATE:		--
FROM:	    	https://github.com/maxroberts/Keithley-2400-SourceMeter-
		  Python-Interface/blob/master/keithley_serial.py
